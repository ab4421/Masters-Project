...
struct AppClipFurnitureEditView: View {
    ...
    private let configurationManager = AppClipConfigurationManager.shared
        ...
        NavigationView {
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("In the full app, changes are saved permanently. Here, changes last only for this session.")
                        .font(.subheadline)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button("Done") {
                        ...
                        // Save configuration to App Clip session storage
